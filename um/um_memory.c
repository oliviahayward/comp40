 ...
 * Does: It adds a segment of memory with space for the specified number of
 *       codewords. If there is a previously unmapped segment available, the
 *       program will use that one first. If not, it will allocate a new
 *       segment of memory.
